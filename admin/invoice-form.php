...
<form method="post">
    ...
    <table class="form-table">
        <tr><th>Client Name</th><td><input type="text" name="client_name" required></td></tr>
        <tr><th>Event Date</th><td><input type="date" name="event_date" value="<?= esc_attr($today) ?>" required></td></tr>
        <tr><th>Function</th><td><input type="text" name="function"></td></tr>
        <tr><th>Venue</th><td><input type="text" name="venue"></td></tr>
    </table>
    <h2>Items</h2>
    <table id="invoice-items" class="widefat">
        <thead>
            <tr><th>S.No.</th><th>Description</th><th>Quantity</th><th>Rate (₹)</th><th>Discount (₹/qty)</th><th>Amount (₹)</th><th></th></tr>
        </thead>
        <tbody></tbody>
    </table>
...
<style>
#invoice-items input { width: 100px; }
#invoice-items th, #invoice-items td { text-align: center; }
</style>
<script>addItemRow();</script> 